...
export function fromPredicate<F extends URIS4>(
  ...
  <A, B extends A, E>(refinement: Refinement<A, B>, onFalse: (a: Exclude<A, B>) => E): <S, R>(
    a: A
  ) => Kind4<F, S, R, E, B>
...
export function fromPredicate<F extends URIS3>(
  ...
  <A, B extends A, E>(refinement: Refinement<A, B>, onFalse: (a: Exclude<A, B>) => E): <R>(a: A) => Kind3<F, R, E, B>
...
export function fromPredicate<F extends URIS3, E>(
  ...
  <A, B extends A>(refinement: Refinement<A, B>, onFalse: (a: Exclude<A, B>) => E): <R>(a: A) => Kind3<F, R, E, B>
...
export function fromPredicate<F extends URIS2>(
  ...
  <A, B extends A, E>(refinement: Refinement<A, B>, onFalse: (a: Exclude<A, B>) => E): (a: A) => Kind2<F, E, B>
...
export function fromPredicate<F>(
  ...
  <A, B extends A, E>(refinement: Refinement<A, B>, onFalse: (a: Exclude<A, B>) => E): (a: A) => HKT2<F, E, B>
...
export function fromPredicate<F>(
  ...
  return <A, E>(predicate: Predicate<A>, onFalse: (a: never) => E) => (a: A) =>
    F.fromEither(predicate(a) ? _.right(a) : _.left(onFalse(a as never)))
}
...
export function filterOrElse<M extends URIS3>(
  ...
  <A, B extends A, E>(refinement: Refinement<A, B>, onFalse: (a: Exclude<A, B>) => E): <R>(
    ma: Kind3<M, R, E, A>
  ) => Kind3<M, R, E, B>
...
export function filterOrElse<M extends URIS2>(
  ...
  <A, B extends A, E>(refinement: Refinement<A, B>, onFalse: (a: Exclude<A, B>) => E): (
    ma: Kind2<M, E, A>
  ) => Kind2<M, E, B>
...
export function filterOrElse<M extends URIS2>(
  ...
  return <A, E>(predicate: Predicate<A>, onFalse: (a: never) => E) => (ma: Kind2<M, E, A>): Kind2<M, E, A> =>
    M.chain(ma, (a) => F.fromEither(predicate(a) ? _.right(a) : _.left(onFalse(a as never))))
}
